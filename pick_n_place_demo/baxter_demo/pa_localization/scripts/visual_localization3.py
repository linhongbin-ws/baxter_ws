...
class visual_localization:
  ...
  def callback(self,data):
    ...
    try:
      ...
      self.pick_location0.x=(cx_leap+5.0)/0.8429/1000.0
      self.pick_location0.y=(cy_leap+1.0)/0.8429/1000.0
      ...
      if(len(cntrs)>=3):
        ...
        self.pick_location1.x=(cx_box+22)/0.90/1000.0
        self.pick_location1.y=(cy_box+5)/0.90/1000.0
